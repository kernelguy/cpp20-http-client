...
[[nodiscard]]
inline Response receive_response(http_client::Socket const&& socket, std::string&& url, http_client::algorithms::ResponseCallbacks&& callbacks, const std::chrono::steady_clock::time_point&& start_time_point) {
